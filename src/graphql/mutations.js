...
export const POST_QUESTION = gql`
  mutation addQuestion($title: String!, $department: String!, $courseName: String!, $courseCode: String! $body: String!, $tags: [String!]!) {
    postQuestion(title: $title, department: $department, courseName: $courseName, courseCode: $courseCode, body: $body, tags: $tags) {
      ...QuestionDetails
    }
  }
  ${QUESTION_DETAILS}
...
export const EDIT_QUESTION = gql`
  mutation updateQuestion(
    ...
    editQuestion(quesId: $quesId, title: $title, department: $department, courseName: $courseName, courseCode: $courseCode, body: $body, tags: $tags) {
      ...QuestionDetails
    }
  }
  ${QUESTION_DETAILS}
